...
/**
 * Foundation CRM - Complete Enhanced Version
        ...
        {!showRegister ? (
          <div className="space-y-5">
            ...
            <button 
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white p-3 rounded-xl font-semibold hover:from-blue-700 hover:to-blue-800 transition-all
            // ============================================
// CANVASSER DASHBOARD - WITH NEW MENU BAR
// ============================================

const CanvasserDashboard = (props) => {
  const { view, setView, currentUser, handleLogout, leadsThisWeek, selectedCustomer, setSelectedCustomer } = props;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      ...
      <div className="bg-white/10 backdrop-blur-md border-b border-white/20 sticky top-0 z-40">
        <div className="px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <button 
              ...
              className="bg-red-500/90 text-white px-4 py-2 rounded-lg hover:bg-red-600 flex items-center gap-2 text-sm"
            >
        ...
        {/* NEW MENU BAR NAVIGATION */}
        <div className="flex overflow-x-auto px-4 pb-2 gap-2 scrollbar-hide">
          <button 
            onClick={() => setView('canvasser-dashboard')} 
            className={`px-4 py-2 rounded-lg font-semibold whitespace-nowrap text-sm flex items-center gap-2 ${view === 'canvasser-dashboard' ? 'bg-blue-600 text-white' : 'bg-white/20 text-white hover:bg-white/30'}`}
          >
            <Activity size={16} />
            Dashboard
          </button>
          <button 
            ...
            className={`px-4 py-2 rounded-lg font-semibold whitespace-nowrap text-sm flex items-center gap-2 ${view === 'canvasser-form' ? 'bg-blue-600 text-white' : 'bg-white/20 text-white hover:bg-white/30'}`}
          >
            <UserPlus size={16} />
            New Homeowner
          </button>
          <button 
            ...
            className={`px-4 py-2 rounded-lg font-semibold whitespace-nowrap text-sm flex items-center gap-2 ${view === 'lead-hub' ? 'bg-blue-600 text-white' : 'bg-white/20 text-white hover:bg-white/30'}`}
          >
            <MapPin size={16} />
            Lead Hub
          </button>
          <button 
            ...
            className={`px-4 py-2 rounded-lg font-semibold whitespace-nowrap text-sm flex items-center gap-2 ${view === 'my-leads' ? 'bg-blue-600 text-white' : 'bg-white/20 text-white hover:bg-white/30'}`}
          >
            <FileText size={16} />
          ...
          <button 
            ...
            className={`px-4 py-2 rounded-lg font-semibold whitespace-nowrap text-sm flex items-center gap-2 ${view === 'team' ? 'bg-blue-600 text-white' : 'bg-white/20 text-white hover:bg-white/30'}`}
          >
...
const Badge = ({ text, color }) => {
  ...
  return (
    <span className={`text-xs ${colors[color]} px-2 py-1 rounded font-semibold`}>{text}</span>
  );
};

// ============================================
// TEAM MESSAGING COMPONENT - NEW FEATURE
// ============================================
...
// ============================================
// CANVASSER FORM - Lead creation form WITH FIXED AUTOCOMPLETE
// ============================================
